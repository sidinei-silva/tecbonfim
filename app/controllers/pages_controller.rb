class PagesController < ApplicationController
  def home
    ...
    @palestras_dia5 = @palestras.where(dia_palestra: "2018-12-05").order("hora_palestra")
    @palestras_dia6 = @palestras.where(dia_palestra: "2018-12-06").order("hora_palestra")
    @palestras_dia7 = @palestras.where(dia_palestra: "2018-12-07").order("hora_palestra")
